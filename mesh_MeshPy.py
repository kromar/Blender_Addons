...
class UIElements(bpy.types.PropertyGroup):
    ...
    #tetgen checkboxes
    make_subdivision = bpy.props.BoolProperty(name="Subdivide Surface", default=True, description="Boundary facets/segments splitting.")
    make_active = bpy.props.BoolProperty(name="Make active", default=True, description="make generated mesh active")   
    make_split = bpy.props.BoolProperty(name="Split", default=False, description="generate each tetrahedron as new object")
    make_softbody = bpy.props.BoolProperty(name="Softbody", default=False, description="new tetras will become softbodys") 
    make_softbody_goal = bpy.props.BoolProperty(name="Softbody Goal", default=False, description="new tetras will become softbodys") 
    ...
    physics_type = bpy.props.EnumProperty(name="Physics Type", items=itemlist, default = '5')
    
    #mesh slicer checkboxes
    apply_scale = bpy.props.BoolProperty(name="Apply scale", default=True, description="apply scale to object before slicing")
    apply_rotation = bpy.props.BoolProperty(name="Apply rotation", default=False, description="apply rotation to object before slicing")
    #mesh slicer sliders
    ratio_xSlice0 = bpy.props.FloatProperty(name="+ X ", subtype='PERCENTAGE', min=0, max=100, default=0, description="+ X axis slicer", update=update_Slicer)
    ratio_ySlice0 = bpy.props.FloatProperty(name="+ Y ", subtype='PERCENTAGE', min=0, max=100, default=0, description="+ Y axis slicer", update=update_Slicer)
    ratio_zSlice0 = bpy.props.FloatProperty(name="+ Z ", subtype='PERCENTAGE', min=0, max=100, default=0, description="+ Z axis slicer", update=update_Slicer)
    ratio_xSlice6 = bpy.props.FloatProperty(name="- X ", subtype='PERCENTAGE', min=0, max=100, default=0, description="- X axis slicer", update=update_Slicer)
    ratio_ySlice6 = bpy.props.FloatProperty(name="- Y ", subtype='PERCENTAGE', min=0, max=100, default=0, description="- Y axis slicer", update=update_Slicer)
    ratio_zSlice6 = bpy.props.FloatProperty(name="- Z ", subtype='PERCENTAGE', min=0, max=100, default=0, description="- Z axis slicer", update=update_Slicer)
